...
import com.pnt.flutter_audio.types.WithFiltersType.checkAlbumsArgs
import com.pnt.flutter_audio.types.WithFiltersType.checkArtistsArgs
import com.pnt.flutter_audio.types.WithFiltersType.checkGenresArgs
import com.pnt.flutter_audio.types.WithFiltersType.checkPlaylistsArgs
import com.pnt.flutter_audio.types.WithFiltersType.checkProjection
import com.pnt.flutter_audio.types.WithFiltersType.checkSongsArgs
import com.pnt.flutter_audio.types.WithFiltersType.checkWithFiltersType
...
class WithFiltersQuery : ViewModel() {
    ...
    fun queryWithFilters() {
        ...
        argsKey = when (withType) {
            ...
            MediaStore.Audio.Media.EXTERNAL_CONTENT_URI -> checkPlaylistsArgs(
                call.argument<Int>(
                    "args"
                )!!
            )
