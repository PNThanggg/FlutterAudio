...
import com.pnt.flutter_audio.MainActivity
import com.pnt.flutter_audio.PluginProvider
import com.pnt.flutter_audio.interfaces.PermissionManagerInterface
import io.flutter.Log
import io.flutter.plugin.common.PluginRegistry.RequestPermissionsResultListener

class PermissionController : PermissionManagerInterface, RequestPermissionsResultListener {
    companion object {
    ...
    override fun onRequestPermissionsResult(
        ...
        when {
            isPermissionGranted -> PluginProvider.result().success(true)
            retryRequest -> retryRequestPermission()
            else -> PluginProvider.result().success(false)
        }
