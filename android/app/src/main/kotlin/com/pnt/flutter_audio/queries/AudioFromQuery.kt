...
import com.pnt.flutter_audio.types.AudiosFromType.checkAudiosFromType
import com.pnt.flutter_audio.types.sorttypes.SongSortType.checkSongSortType
...
class AudioFromQuery : ViewModel() {
    ...
    fun querySongsFrom() {
        ...
        // Add a better way to handle this query
    ...
    private fun querySongsFromPlaylistOrGenre(
        ...
        pUri = if (type == 4 || type == 5) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                MediaStore.Audio.Media.getContentUri("external", pId.toLong())
            } else {
